!(function (e, t) {
  ...
  function h(e, t) {
    o(t.split(" "), function (t) {
      return e.classNameNameList.add(t);
    });
  }
  function d(e, t) {
    o(t.split(" "), function (t) {
      return e.classNameNameList.remove(t);
    });
  }
  function c(e, t) {
      ...
      function e(i, n) {
        ...
        (this.active = !1),
          ...
          this.img.addEventListener(
            "click",
            function (e) {
              return s.slide.classNameNameList.contains("dragging-nav")
                ? (s.zoomOut(), !1)
                : s.zoomedIn
        ...
        n(e, [
          {
            ...
            value: function () {
              ...
              if (!(this.zoomedIn || e <= 768)) {
                ...
                this.slide.classNameNameList.add("zoomed"),
                  (this.zoomedIn = !0);
              }
            },
          },
          {
            ...
            value: function () {
              this.img.parentNode.setAttribute("style", ""),
                ...
                this.slide.classNameNameList.remove("zoomed"),
                (this.zoomedIn = !1),
                (this.currentX = null),
                (this.currentY = null),
                (this.initialX = null),
              ...
              e.preventDefault(),
                this.zoomedIn
                  ? ("touchstart" === e.type
                    ...
                    e.target === this.img &&
                      ((this.active = !0),
                      this.img.classNameNameList.add("dragging")))
                  : (this.active = !1);
            },
          },
          {
            ...
            value: function (e) {
              ...
              e.preventDefault(),
                ...
                setTimeout(function () {
                  (t.dragging = !1),
                    (t.img.isDragging = !1),
                    t.img.classNameNameList.remove("dragging");
                }, 100);
            },
          },
          {
        ...
        n(e, [
          {
            key: "dragStart",
            value: function (e) {
              if (this.slide.classNameNameList.contains("zoomed"))
                this.active = !1;
              else {
                "touchstart" === e.type
                  ? ((this.initialX = e.touches[0].clientX - this.xOffset),
                ...
                e.target.classNameNameList.contains("nodrag") ||
                u(e.target, ".nodrag") ||
                -1 !== ["input", "select", "textarea", "button", "a"].indexOf(t)
                  ...
                  : (e.preventDefault(),
                    (e.target === this.el ||
                      ...
                      ((this.active = !0),
                      this.el.classNameNameList.add("dragging"),
              ...
              e && e.preventDefault(),
                ...
                setTimeout(function () {
                  (t.instance.preventOutsideClick = !1),
                    ...
                    (t.dragging = !1),
                    (t.el.isDragging = !1),
                    t.el.classNameNameList.remove("dragging"),
                    t.slide.classNameNameList.remove("dragging-nav"),
          ...
          },
          {
            ...
            value: function (e) {
              if (this.active) {
                e.preventDefault(),
                  this.slide.classNameNameList.add("dragging-nav"),
                  "touchmove" === e.type
                    ? ((this.currentX = e.touches[0].clientX - this.initialX),
                      (this.currentY = e.touches[0].clientY - this.initialY))
                    : ((this.currentX = e.clientX - this.initialX),
  ...
  function F(e, t, i, n) {
    ...
    h(l, "gvideo-container"),
      r.insertBefore(
        m('<div classNameName="gvideo-wrapper"></div>'),
        r.firstChild
      );
  ...
  function G(e, t, i, n) {
    ...
    if (
      d &&
      (C(d) &&
        (s = m('<div classNameName="ginlined-content">'.concat(d, "</div>"))),
      k(d))
    ) {
  ...
  var $ = (function () {
        ...
        n(e, [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              return l
                ? ((n = null),
                  o + '... <a href="#" classNameName="desc-more">' + i + "</a>")
                : o;
            },
          },
          {
    ...
    ee = {
      ...
      slideHTML:
        '<div classNameName="gslide">\n    <div classNameName="gslide-inner-content">\n        <div classNameName="ginner-container">\n            <div classNameName="gslide-media">\n            </div>\n            <div classNameName="gslide-description">\n                <div classNameName="gdesc-inner">\n                    <h4 classNameName="gslide-title"></h4>\n                    <div classNameName="gslide-desc"></div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>',
      lightboxHTML:
        '<div id="glightbox-body" classNameName="glightbox-container" tabindex="-1" role="dialog" aria-hidden="false">\n    <div classNameName="gloader visible"></div>\n    <div classNameName="goverlay"></div>\n    <div classNameName="gcontainer">\n    <div id="glightbox-slider" classNameName="gslider"></div>\n    <button classNameName="gclose gbtn" aria-label="Close" data-taborder="3">{closeSVG}</button>\n    <button classNameName="gprev gbtn" aria-label="Previous" data-taborder="2">{prevSVG}</button>\n    <button classNameName="gnext gbtn" aria-label="Next" data-taborder="1">{nextSVG}</button>\n</div>\n</div>',
    },
    te = (function () {
      function e() {
        var i =
        ...
        t(this, e),
          ...
          (this.effectsclassNameNamees = this.getAnimationclassNameNamees()),
          (this.videoPlayers = {}),
          (this.apiEvents = []),
        ...
        n(e, [
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.slideDescription = s.querySelector(".gslide-description")),
                ...
                this.updateNavigationclassNameNamees(),
                (this.activeSlide = s);
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              if (
                ...
                d(e, this.effectsclassNameNamees),
                t)
              )
                g(
                  e,
          ...
          },
          {
            ...
            value: function () {
              ...
              d(e, this.effectsclassNameNamees), h(e, "prev");
          ...
          {
            key: "getAnimationclassNameNamees",
            value: function () {
              var e = [];
          ...
          {
            key: "updateNavigationclassNameNamees",
            value: function () {
              var e = this.loop();
